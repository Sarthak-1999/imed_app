...
import 'package:imed_app/components/theme_provider.dart';
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          for (var post in userdata!) {
            ...
            final postSenderImage = {
              post.data(): ['senderProfileImageUrl']
            };
            final postType = {
              post.data(): ['postType']
            };
...
class _UserDescriptionState extends State<UserDescription> {
  ...
  //                   final commentSenderId = comment.data()['commentSenderId'];
  //                   final commentSenderImage =
  //                       comment.data()['commentSenderImageUrl'];
  //                   final commentSender = comment.data()['commentSender'];
  //                   // final postImageUrl = post.data()['postImageUrl'];
  //                   // final postLikeCounter = post.data()['postLikeCounter'];
...
//   CommentsList(
//       {this.commentSender,
//       this.commentSenderId,
//       this.commentText,
//       this.commentSenderImageUrl,
